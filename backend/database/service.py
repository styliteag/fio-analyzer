    ...
    def execute_write(
        ...
        with self.get_connection() as conn:
            try:
                ...
                conn.rollback()
                log_error("Write operation error", e, {
                    "query": query,
                    "parameters": parameters
                })
    ...
    def execute_many(
        ...
        with self.get_connection() as conn:
            try:
                ...
                conn.rollback()
                log_error("Batch operation error", e, {
                    "query": query,
...
class TestRunService(DatabaseService):
    ...
    def get_test_runs(
        ...
        log_info("Executing test runs query", {
            "filters": {
    ...
    def get_filter_options(self) -> Dict[str, List[str]]:
        ...
        filter_columns = [
            "hostname", "drive_type", "drive_model", "protocol", 
            "read_write_pattern", "block_size", "sync", "queue_depth", 
            "direct", "num_jobs"
        ]
