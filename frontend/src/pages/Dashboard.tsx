          ...
          <div className="theme-bg-accent border theme-border-accent rounded-lg p-6 text-center mt-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
              <div className="theme-bg-card p-4 rounded border theme-border-accent">
                <div className="font-medium theme-text-accent mb-1">1. Select Test Runs</div>
                <div className="theme-text-accent">Choose benchmark results to compare</div>
              </div>
              <div className="theme-bg-card p-4 rounded border theme-border-accent">
                <div className="font-medium theme-text-accent mb-1">2. Pick a Template</div>
                <div className="theme-text-accent">Select visualization type for your analysis</div>
              </div>
              <div className="theme-bg-card p-4 rounded border theme-border-accent">
                <div className="font-medium theme-text-accent mb-1">3. Analyze Results</div>
                <div className="theme-text-accent">Interactive charts with export options</div>
              </div>
            </div>
