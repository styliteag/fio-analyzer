        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center">
              ...
              <h1 className="text-2xl font-bold text-gray-900">Upload FIO Results</h1>
            </div>
          </div>
        </div>
      </header>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="mb-8">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-xl font-semibold text-gray-900">Import Benchmark Data</h2>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg p-4 mb-6">
              <h3 className="font-medium text-gray-900 mb-2">Generate FIO JSON files with these commands:</h3>
              <div className="space-y-2 text-sm font-mono text-gray-700">
                <div className="bg-white p-2 rounded border">
                  <div className="text-gray-500 text-xs mb-1"># Sequential read test</div>
                  <div>fio --name=seqread --rw=read --bs=64k --iodepth=16 --runtime=60 --time_based --output-format=json --output=results.json</div>
                </div>
                <div className="bg-white p-2 rounded border">
                  <div className="text-gray-500 text-xs mb-1"># Random mixed workload</div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label htmlFor="drive-model" className="block text-sm font-medium text-gray-700 mb-2">
                  Drive Model
                </label>
                <input
                  id="drive-model"
                ...
                />
                <p className="mt-1 text-xs text-gray-500">Optional: Specify the storage device model</p>
              </div>
