...
export default function BulkEditModal({ testRuns, isOpen, onClose, onSave }: BulkEditModalProps) {
  ...
  const handleSave = async () => {
    ...
    if (!updateDriveModel && !updateDriveType && !updateHostname && !updateProtocol) {
    ...
    try {
      ...
      if (failed > 0) {
        setError(`Updated ${testRuns.length - failed} of ${testRuns.length} test runs. ${failed} failed.`);
      }
      ...
      <div className="theme-modal rounded-lg shadow-xl max-w-lg w-full border">
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="theme-bg-secondary rounded-lg p-4 text-sm border theme-border-secondary">
            <div className="font-medium theme-text-primary mb-2">Selected Test Runs:</div>
          ...
          <div className="theme-form-group">
            <div className="flex items-center mb-2">
              <input
                ...
                disabled={saving}
              />
              <label htmlFor="update-drive-model" className="theme-form-label mb-0">
                Update Drive Model
              </label>
            </div>
            <input
          ...
          <div className="theme-form-group">
            <div className="flex items-center mb-2">
              <input
                ...
                disabled={saving}
              />
              <label htmlFor="update-drive-type" className="theme-form-label mb-0">
                Update Drive Type
              </label>
            </div>
            {!showCustomType ? (
          ...
          <div className="theme-form-group">
            <div className="flex items-center mb-2">
              <input
                ...
                disabled={saving}
              />
              <label htmlFor="update-hostname" className="theme-form-label mb-0">
                📡 Update Hostname
              </label>
            </div>
            <input
          ...
          <div className="theme-form-group">
            <div className="flex items-center mb-2">
              <input
                ...
                disabled={saving}
              />
              <label htmlFor="update-protocol" className="theme-form-label mb-0">
                🔗 Update Protocol
              </label>
            </div>
            <select
        ...
        <div className="flex items-center justify-end gap-3 p-6 border-t theme-border-primary theme-bg-secondary">
          ...
          <button
            onClick={handleSave}
            disabled={saving || (!updateDriveModel && !updateDriveType && !updateHostname && !updateProtocol)}
